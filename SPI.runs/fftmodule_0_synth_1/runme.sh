...
HD_PWD='C:/Users/RisingEntropy/Documents/Projects/FPGA/SPI/SPI.runs/fftmodule_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fftmodule_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fftmodule_0.tcl
