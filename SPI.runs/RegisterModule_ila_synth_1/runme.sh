...
HD_PWD='C:/Users/RisingEntropy/Documents/Projects/FPGA/SPI/SPI.runs/RegisterModule_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegisterModule_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RegisterModule_ila.tcl
