...
HD_PWD='C:/Users/RisingEntropy/Documents/Projects/FPGA/SPI/SPI.runs/configurablereceiver_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log configurablereceiver_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source configurablereceiver_0.tcl
