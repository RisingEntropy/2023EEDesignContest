...
HD_PWD='C:/Users/RisingEntropy/Documents/Projects/FPGA/SPI/SPI.runs/decimator_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decimator_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decimator_ila.tcl
