...
#
# Generated by export_simulation on Thu Aug 03 11:19:13 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './decimator_0.sh' script.

./decimator_0.sh -reset_run
...
./decimator_0.sh -noclean_files

For more information on the script, please type './decimator_0.sh -help'.
