...
#
# Generated by export_simulation on Tue Aug 01 17:22:56 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './configurablereceiver_0.sh' script.

./configurablereceiver_0.sh -reset_run
...
./configurablereceiver_0.sh -noclean_files

For more information on the script, please type './configurablereceiver_0.sh -help'.
