...
#
# Generated by export_simulation on Sat Jul 29 15:08:10 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './fftmodule_0.sh' script.

./fftmodule_0.sh -reset_run
...
./fftmodule_0.sh -noclean_files

For more information on the script, please type './fftmodule_0.sh -help'.
