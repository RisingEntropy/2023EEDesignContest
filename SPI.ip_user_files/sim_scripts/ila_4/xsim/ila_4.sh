...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_4 xil_defaultlib.ila_4 xil_defaultlib.glbl -log elaborate.log
}
